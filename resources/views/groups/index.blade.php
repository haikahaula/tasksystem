                ...
                @foreach($groups as $index => $group)
                    <tr class="border-t hover:bg-gray-100">
                        ...
                        <td class="px-4 py-2 border space-x-2">
                            <a href="{{ route('groups.show', $group->id) }}" title="View" class="text-blue-600 hover:text-blue-800">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('groups.edit', $group->id) }}" title="Edit" class="text-yellow-500 hover:text-yellow-700">
