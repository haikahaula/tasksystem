                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    @if ($user)
                        ...
                        @elseif(Str::contains($user->email, 'head'))
                            <x-nav-link :href="route('academic-head.dashboard')" :active="request()->routeIs('academic-head.dashboard')">
                                Head Dashboard
                            </x-nav-link>
                        ...
                        @elseif(Str::contains($user->email, 'staff'))
                            <x-nav-link :href="route('academic-staff.dashboard')" :active="request()->routeIs('academic-staff.dashboard')">
                                Staff Dashboard
                            </x-nav-link>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @if ($user)
                ...
                @elseif(Str::contains($user->email, 'head'))
                    <x-responsive-nav-link :href="route('academic-head.dashboard')" :active="request()->routeIs('academic-head.dashboard')">
                        Head Dashboard
                    </x-responsive-nav-link>
                @elseif(Str::contains($user->email, 'staff'))
                    <x-responsive-nav-link :href="route('academic-staff.dashboard')" :active="request()->routeIs('academic-staff.dashboard')">
                        Staff Dashboard
                    </x-responsive-nav-link>
